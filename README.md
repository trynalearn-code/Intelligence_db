...
Intelligence_db is a RESTful project that incorporates mysql, docker, fastapi and swagger. The project is written in Clean Code as well. The data is called through HTML.
